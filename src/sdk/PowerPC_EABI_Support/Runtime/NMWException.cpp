// https://github.com/xbret/xenoblade/blob/main/libs/PowerPC_EABI_Support/src/Runtime/NMWException.cp
...
public:
    ...
    __partial_array_destructor(
        void *array, size_t elementsize, size_t nelements, ConstructorDestructor destructor
    ) {
        p = array;
        size = elementsize;
        n = nelements;
